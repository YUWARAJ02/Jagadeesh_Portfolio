    ...
    return (
        <div id='home'>
            <img className='w-full h-screen object-cover'
                src='assets/viyagar.jpeg' />
            <div className='w-full h-screen absolute top-0 left-0 bg-white/60'>
                <div className='max-w-[700px] m-auto h-full w-full flex flex-col justify-center lg:items-start items-center'>
                    <h1 className='sm:text-5xl text-4xl font-bold text-gray-800'>I'm Jagadeesh</h1>
                    <h2 className='flex sm:text-3xl text-2xl pt-4 text-gray-800'>I'm a {' '}
                        <TypeAnimation
                            sequence={[
                                'Embedded AI Developer', // Types 'One'
                                2000, // Waits 2s
                                'Research Enthusiast', // Deletes 'One' and types 'Two'
                                2000, // Waits 2s
                                'King', // Types 'Three' without deleting 'Two'
                                2000,
                            ]}
                            wrapper="div"
                            cursor={true}
